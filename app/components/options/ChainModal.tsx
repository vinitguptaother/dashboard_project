                  ...
                  >
                    ...
                    <td className="py-1.5 px-1 text-center">
                      {ceLegId ? (
                        ...
                        <button onClick={() => onAddLeg(s, 'CE', defaultSide)} className="w-7 h-7 rounded-full border border-gray-300 dark:border-gray-600 hover:bg-green-50 dark:hover:bg-green-900/20 flex items-center justify-center mx-auto text-gray-400 hover:text-green-500">
                    ...
                    <td className="py-1.5 px-1 text-center">
                      {peLegId ? (
                        ...
                        <button onClick={() => onAddLeg(s, 'PE', defaultSide)} className="w-7 h-7 rounded-full border border-gray-300 dark:border-gray-600 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center justify-center mx-auto text-gray-400 hover:text-red-500">
                          <Plus className="w-3.5 h-3.5" />
                        </button>
                      )}
                    </td>
